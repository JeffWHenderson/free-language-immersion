...
const SRSReview = () => {
    ...
    const { readFront, readBack, fastMode, shuffleCards, displayMode, autoplay, setAutoplay } = useLanguageApp();
    ...
    useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [fastMode, fastModeIndex, deck, autoplay, displayMode, ttsEnFirst]);
