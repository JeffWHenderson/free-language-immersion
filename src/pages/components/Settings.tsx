...
const Settings = ({ language, onShuffle, isShuffled }: { language?: string; onShuffle?: () => void; isShuffled?: boolean }) => {
    const { readFront, setReadFront, readBack, setReadBack, fastMode, setFastMode, volume, setVolume, showLiteral, setShowLiteral, showRomanized, setShowRomanized, displayMode, setDisplayMode } = useLanguageApp();
                ...
                <div className="srs-settings-dropdown">
                    {onShuffle && (
                        <div className="srs-settings-row">
                            <button
                                className="srs-settings-action-btn"
                    ...
                    <div className="srs-settings-row">
                        <div className="srs-settings-label-group">
                            ...
                            <span className="srs-settings-sub">Show romanized pronunciation</span>
                        </div>
                        <label className="srs-toggle">
                            <input
                                type="checkbox"
                                checked={showRomanized}
                                onChange={(e) => setShowRomanized((e.currentTarget as HTMLInputElement).checked)}
                            />
                            <span className="srs-toggle-track" />
                        </label>
                    </div>
