...
const FlipCard = ({
    ...
    isFlipped, onFlip, noteOpen, onNoteToggle, reversed, backExtra, cardCorner,
}: FlipCardProps) => {
    const { displayMode, showLiteral } = useLanguageApp();
                ...
                <div className="srs-card-front">
                    ...
                    {reversed ? (
                        <>
                            ...
                            {displayMode !== 'phrase' && romanized && <div className="srs-romanized">{romanized}</div>}
                            {displayMode !== 'word' && phrase && <div className="eszh-phrase">{phrase}</div>}
                            {displayMode !== 'word' && phraseRomanized && <div className="eszh-phrase-pin">{phraseRomanized}</div>}
                        </>
                    ) : (
                        <>
