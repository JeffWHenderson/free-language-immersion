    ...
    return (
        <div className="lang-home">
            ...
            <div className="lang-home-courses">
                <button className="lang-course-btn" onClick={() => navigate('/spanish')} onMouseEnter={() => prefetchLanguage('spanish')}>
                    Spanish Course →
                </button>
                <button className="lang-course-btn" onClick={() => navigate('/chinese')} onMouseEnter={() => prefetchLanguage('chinese')}>
                    Chinese Course →
                </button>
                <button className="lang-course-btn" onClick={() => navigate('/japanese')} onMouseEnter={() => prefetchLanguage('japanese')}>
                    Japanese Course →
                </button>
                <button className="lang-course-btn" onClick={() => navigate('/arabic')} onMouseEnter={() => prefetchLanguage('arabic')}>
                    Arabic Course →
                </button>
                <button className="lang-course-btn" onClick={() => navigate('/french')} onMouseEnter={() => prefetchLanguage('french')}>
                    French Course →
                </button>
